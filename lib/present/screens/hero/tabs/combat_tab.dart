...
import 'defense_tab.dart';
import 'attack_tab.dart';

class CombatTab extends StatelessWidget {
  final HeroModel hero;
  final Function(BuildContext) onShowDefenseEditModal;
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          // КБ
          GestureDetector(
            onTap: () => onShowDefenseEditModal(context),
            child: Row(
              children: [
                Expanded(
                  child: CardValue(
  ...
  // Методы для расчета параметров защиты
  ...
  // Методы для расчета параметров атаки
